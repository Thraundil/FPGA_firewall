...
# Test description
print 'Test_7:'
print '''Tests that incoming SYN Floods gets blocked,
         both from whitelisted and non-whitelisted IP's, as
         well as non-whitelisted IP's in State (due to outgoing
         traffic visiting said IP) '''
...
tcp_incoming  = [
                 ["42.42.42.42","1.1.1.1","42","2"],
                 ["42.42.42.42","1.1.1.1","42","2"],
                 ["42.42.42.42","1.1.1.1","42","2"], 
                 ["20.20.20.20","1.1.1.1","42","2"],
                 ["20.20.20.20","1.1.1.1","42","2"],
                 ["20.20.20.20","1.1.1.1","42","2"],
                 ["20.20.20.20","1.1.1.1","42","2"],
                 ["20.20.20.20","1.1.1.1","42","2"],
