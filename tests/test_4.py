...
# Test description
print 'Test_4:'
print '''Tests the blacklists ability to prevent
         outgoing requests completely.
         Also tests if the state can detect a request
         for an already-in-state connection, so duplicates
         won't occur. '''
...
ipv4_outgoing = [
                 ...
                 ["1.1.1.1", "66.66.66.66", "42", "2"], # False
                 ["1.1.1.1", "42.42.42.42", "42", "2"]  # True
                ]
